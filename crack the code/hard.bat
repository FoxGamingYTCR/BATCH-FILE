...
goto :exit
:instructions
echo You play by trying to guess the code, if you guess correctly you will unlock one or multiple numbers. the numbers are 1 to 20
pause
:play
set tries=0
set add=1
set /a RAND=(%RANDOM%*20/32768)+1
set num1=%RAND%
set /a RAND=(%RANDOM%*20/32768)+1
set num2=%RAND%
set /a RAND=(%RANDOM%*20/32768)+1
...
echo tries %tries%, hard mode, code %code%, name %name% >> logs.txt
